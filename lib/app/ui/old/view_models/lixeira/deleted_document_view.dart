...
class DeletedDocumentView extends WatchingStatefulWidget {
  final DeletedDocumentViewModel viewModel;
  const DeletedDocumentView(this.viewModel, {super.key});
...
class _DeletedDocumentViewState extends State<DeletedDocumentView> {
  DeletedDocumentViewModel get viewModel => widget.viewModel;
  ...
  Widget build(BuildContext context) {
    ...
    registerHandler<ValueNotifier, String?>(
      ...
      handler: (context, newValue, _) {
        if (newValue != null && newValue.isNotEmpty) {
          ...
          log('redirectTo is null or empty, no navigation performed');
        }
      },
    );
    ...
    return Scaffold(
      ...
      body: isLoading
          ...
          : widget.viewModel.document != null
